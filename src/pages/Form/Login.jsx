...
const Login = () => {
  ...
  const { handleLogin, handleNavigate } = useMovies();
    ...
    <div>
      {login === "login" ? (
        <div className="flex items-center justify-center h-screen relative">
          ...
          />
          <div className="absolute top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 max-w-[500px] flex flex-col gap-y-10 items-center">
            <h1 className="text-2xl font-medium leading-10 text-center">
              Bạn đã đăng nhập thành công vui lòng ấn vào đây để quay lại trang
              chủ
            </h1>
            <Button
              text={"Về Trang Chủ"}
        ...
        <div className="flex items-center justify-center h-screen relative">
          ...
          <Formik
            ...
            {(formik) => (
              <Form className="absolute top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 w-full max-w-[400px] mx-auto font-poppins bg-transparent border border-purple-600 p-5 rounded-lg">
